...
The Mobiscroll Trial comes with a number of limitations including:
 ...
 - Disabled debugging. You won't be able to debug Mobiscroll or your application while using a trial build. When using developer tools you will need to disable all breakpoints across the whole application.
